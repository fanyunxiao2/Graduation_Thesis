          ...
          if T_sum.Et() > 80: 
              if cut1 == 2:
                  if cut2 == 2:
                      if abs(cut3) < cut31:
                          if abs(DPhi1) < 2.2:
                              if abs(MISSPT.Phi()-T_sum.Phi()) > 0.5:
                                  pt = T_sum.M()
                                  data.append(pt) 
...
if __name__ == "__main__":
  ...
  input_file="/home/greenhand/download/MG5_aMC_v3_3_2/bin/h1/Events/run_07/unweighted_events.lhe.gz"
