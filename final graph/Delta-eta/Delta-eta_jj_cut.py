                  ...
                  if cut3 == 2:
                      ...
                      if abs(cut4) < anum:
                          ...
                          if abs(DPhi1) < 2.2:
                              #cut5
                              data.append(abs(pt)) 
                            #export the Delta-eta and save them to the list named data
                              ...
                              if abs(pt) < ptmin_middle:
                                  ptmin = abs(pt)
                                  ptmin_middle = ptmin
                              #find the Max and Min of the Delta-eta
                              enum += 1
...
def read_lhe5(input_file):
  ...
  for i, pt in enumerate(data):
    h5.Fill(pt)
  h5.Scale(0.002852*139*1000000/50000)
  h5.SetLineColor(7)
...
if __name__ == "__main__":
  ...
  myC.SaveAs("Delta-etaall_jj_cut.png")
