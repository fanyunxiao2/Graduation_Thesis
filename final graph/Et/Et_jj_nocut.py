...
def read_lhe1(input_file):
  ...
  for i, pt in enumerate(data):
    h1.Fill(pt)
  h1.Scale(0.001245*139*1400000*1.7/200000)
  h1.SetLineColor(1)
...
def read_lhe2(input_file):
  ...
  for i, pt in enumerate(data):
    h2.Fill(pt)
  h2.Scale(0.005023*139*500000/200000)
  h2.SetLineColor(2)
...
def read_lhe5(input_file):
  ...
  for i, pt in enumerate(data):
    h5.Fill(pt)
  h5.Scale(0.002852*139*2500000/50000)
  h5.SetLineColor(7)
