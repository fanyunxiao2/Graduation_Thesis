...
def read_lhe1(input_file):
  ...
  for event in lhe:
      ...
      cut4 = 0
      anum = 0
      #parameters about cut4
      bnum = 1
      DPhi1 = 0
      #parameters about cut5
      ptmax = 0
      ptmin = 10000000
      ptmax_middle = 0
      ptmin_middle = 0
                  ...
                  if cut3 == 2:
                      ...
                      if abs(cut4) < anum:
                          ...
                          if abs(DPhi1) < 2.2:
                              ...
                              pt = T_sum.Et()
                              data.append(pt) 
                             #export the missing Et and save them to the list named data
                              ...
                              if abs(pt) < ptmin_middle:
                                  ptmin = abs(pt)
                                  ptmin_middle = ptmin
                              #find the Max and Min of the missing Et
                              enum += 1

  #print (enum)
  #if necessary
  h1.SetTitle("Et;Et/GeV;Yield")
  for i, pt in enumerate(data):
    h1.Fill(pt)
  h1.Scale(0.001245*139*200000/200000)
  h1.SetLineColor(1)
...
def read_lhe2(input_file):
  ...
  #print (enum)
  #if necessary
  h2.SetTitle("Et;Et/GeV;Yield")
  for i, pt in enumerate(data):
    h2.Fill(pt)
  h2.Scale(0.005023*139*40000/200000)
  h2.SetLineColor(2)
...
def read_lhe3(input_file):
  ...
  #print (enum)
  #if necessary
  h3.SetTitle("Et;Et/GeV;Yield")
  for i, pt in enumerate(data):
    h3.Fill(pt)
  h3.Scale(10.98*139*70/200000)
  h3.SetLineColor(3)
...
def read_lhe4(input_file):
  ...
  #print (enum)
  #if necessary
  h4.SetTitle("Et;Et/GeV;Yield")
  for i, pt in enumerate(data):
    h4.Fill(pt)
  h4.Scale(2808*139*2/200000)
  h4.SetLineColor(4)
...
def read_lhe5(input_file):
  ...
  #print (enum)
  #if necessary
  h5.SetTitle("Et;Et/GeV;Yield")
  for i, pt in enumerate(data):
    h5.Fill(pt)
  h5.Scale(0.002852*139*200000/50000)
  h5.SetLineColor(7)
...
if __name__ == "__main__":
  myC = R.TCanvas("c")
  myC.cd()
  h1 = R.TH1F("Et","Et", 25, 0, 1000)
  h2 = R.TH1F("Et","Et", 25, 0, 1000)
  h3 = R.TH1F("Et","Et", 25, 0, 1000)
  h4 = R.TH1F("Et","Et", 25, 0, 1000)
  h5 = R.TH1F("Et","Et", 25, 0, 1000)
  h6 = R.TH1F("Et","Et", 25, 0, 1000)
