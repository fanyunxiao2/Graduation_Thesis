...
def read_lhe1(input_file):
  ...
  print (enum)
  h1.SetTitle("Delta-eta;Delta-eta;fraction")
  for i, pt in enumerate(data):
    h1.Fill(pt)
  h1.Scale(0.001245*139*138888*2/200000)
  h1.SetLineColor(1)
...
def read_lhe2(input_file):
  ...
  h2.SetTitle("Delta-eta;Delta-eta;fraction")
  for i, pt in enumerate(data):
    h2.Fill(pt)
  h2.Scale(0.005023*139*75000/200000)
  h2.SetLineColor(2)
...
def read_lhe3(input_file):
  ...
  h3.SetTitle("Delta-eta;Delta-eta;fraction")
  for i, pt in enumerate(data):
    h3.Fill(pt)
  h3.Scale(10.98*139*66.6*2/200000)
  h3.SetLineColor(3)
...
def read_lhe4(input_file):
  ...
  h4.SetTitle("Delta-eta;Delta-eta;fraction")
  for i, pt in enumerate(data):
    h4.Fill(pt)
  h4.Scale(2808*139*3/200000)
  h4.SetLineColor(4)
...
def read_lhe5(input_file):
  ...
  h5.SetTitle("Delta-eta;Delta-eta;fraction")
  for i, pt in enumerate(data):
    h5.Fill(pt)
  h5.Scale(0.002852*139*100/50000)
  h5.SetLineColor(5)
...
def read_lhe6(input_file):
  ...
  print (enum)
  h6.SetTitle("Delta-eta;Delta-eta;fraction")
  for i, pt in enumerate(data):
    h6.Fill(pt)
...
if __name__ == "__main__":
  ...
  #h5 = R.TH1F("Delta-eta","Delta-eta", 100, 0, 4.5)
