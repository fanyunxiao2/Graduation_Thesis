...
def read_lhe2(input_file):
  ...
  h2.SetTitle("imass;imass/GeV;fraction")
  for i, pt in enumerate(data):
    h2.Fill(pt)
...
def read_lhe3(input_file):
  ...
  h3.SetTitle("imass;imass/GeV;fraction")
  for i, pt in enumerate(data):
    h3.Fill(pt)
...
def read_lhe4(input_file):
  ...
  h4.SetTitle("imass;imass/GeV;fraction")
  for i, pt in enumerate(data):
    h4.Fill(pt)
  h4.Scale(2808*139*6*0.7/200000)
  h4.SetLineColor(4)
...
def read_lhe5(input_file):
  ...
  h5.SetTitle("imass;imass/GeV;fraction")
  for i, pt in enumerate(data):
    h5.Fill(pt)
...
if __name__ == "__main__":
  ...
  #h5 = R.TH1F("imass","imass", 100, 0, 2500)
