...
def read_lhe1(input_file):
  ...
  h1.SetTitle("Et;Et/GeV;fraction")
...
def read_lhe2(input_file):
  ...
  h2.SetTitle("Et;Et/GeV;fraction")
  for i, pt in enumerate(data):
    h2.Fill(pt)
...
def read_lhe3(input_file):
  ...
  h3.SetTitle("Et;Et/GeV;fraction")
  for i, pt in enumerate(data):
    h3.Fill(pt)
...
def read_lhe4(input_file):
  ...
  h4.SetTitle("Et;Et/GeV;fraction")
  for i, pt in enumerate(data):
    h4.Fill(pt)
  h4.Scale(2808*139*22.7/200000)
  h4.SetLineColor(4)
...
def read_lhe5(input_file):
  ...
  h5.SetTitle("Et;Et/GeV;fraction")
  for i, pt in enumerate(data):
    h5.Fill(pt)
  h5.Scale(0.002852*139*80/50000)
  h5.SetLineColor(5)
...
def read_lhe6(input_file):
  ...
  h6.SetTitle("imass;imass/GeV;fraction")
  for i, pt in enumerate(data):
    h6.Fill(pt)
...
if __name__ == "__main__":
  ...
  leg.AddEntry(h6,"BKG","f") 
  leg.Draw()

  myC.SaveAs("TEtj0.png")
